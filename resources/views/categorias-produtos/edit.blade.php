<x-layout>
    ...
    <form method="POST" id="edit-form" action="{{ route('categorias-produtos.update', ['categoria' => $categoria->id]) }}">
        @csrf
        @method('patch')
    ...
    <form id="delete-form" class="hidden" method="POST"
        action="{{ route('categorias-produtos.destroy', ['categoria' => $categoria->id]) }}">
        @csrf
        @method('delete')
    </form>
</x-layout>
