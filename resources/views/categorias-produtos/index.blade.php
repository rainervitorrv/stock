<x-layout>
    ...
    <x-slot:button>
        <x-button.create-button href="{{ route('categorias-produtos.create') }}">Nova Categoria</x-button.create-button>
    </x-slot:button>
            ...
            <tbody>
                @foreach ($categorias as $categoria)
                    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200  hover:bg-gray-50 ">
                        ...
                        <x-table.table-row-td>
                            <a href="{{ route('categorias-produtos.show', ['categoria' => $categoria->id]) }}"
